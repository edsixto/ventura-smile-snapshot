  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 shadow-sm">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h3 className="font-bold text-amber-800">Limited Time Offer</h3>
      </div>
      
      <div className="mb-2">
        <span className="text-2xl font-bold text-amber-900">${currentPrice}</span>
      ...
      <div className="grid grid-cols-4 gap-1 text-center">
        ...
        <div className="bg-amber-100 rounded p-1">
          ...
          <div className="text-xs text-amber-700">secs</div>
        </div>
      </div>
    </div>
  );
